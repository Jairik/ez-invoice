...
func TestRenderWritesInvoiceSections(t *testing.T) {
	...
	for _, text := range []string{"Invoice", "Submitted on 08/05/2026", "Invoice From", "Ada Lovelace", "Invoice To", "Analytical Engines", "Point of Contact", "Invoice #", "Period", "7/14 - 8/2", "Payable", "Net 15", "Development", "consultation", "Subtotal", "Adjustment", "Total", "Thank you"} {
